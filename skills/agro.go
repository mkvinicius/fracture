...
func AgroSkill() *Skill {
	return &Skill{
		...
		Agents: []SkillAgent{
			...
			{
				Name:        "Edu Carvalho",
				Role:        "AgriTech Disruptor & Precision Agriculture Pioneer",
				Traits:      []string{"precision agriculture", "drones", "AI crop monitoring", "input optimization", "digital farm management"},
				Goals:       []string{"reduce input costs 40% through precision", "democratize agricultural intelligence"},
				Biases:      []string{"traditional input-heavy farming", "analog cooperative resistance"},
				Power:       0.80,
				IsDisruptor: true,
			},
			{
			...
			{
				Name:        "Rachel Maia",
				Role:        "ESG & Sustainable Supply Chain Advocate",
				Traits:      []string{"ESG", "supply chain transparency", "deforestation-free", "carbon credits", "sustainable sourcing"},
				Goals:       []string{"trace every ton to deforestation-free origin", "carbon market integration"},
				Biases:      []string{"greenwashing", "traceability gaps", "land grabbing"},
				Power:       0.75,
				IsDisruptor: true,
			},
			{
				Name:        "MAPA Director",
				Role:        "Brazilian Agriculture Ministry Regulator",
				Traits:      []string{"pesticide registration", "seed certification", "animal health", "export sanitary standards", "MAPA"},
				Goals:       []string{"food safety", "export market access maintenance"},
				Biases:      []string{"unapproved inputs", "sanitary standards violations"},
				Power:       0.90,
				IsDisruptor: false,
			},
		},
