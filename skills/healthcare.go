...
func HealthcareSkill() *Skill {
	return &Skill{
		...
		Agents: []SkillAgent{
			...
			{
				Name:        "ANVISA Director",
				Role:        "Brazilian Health Regulatory Authority",
				Traits:      []string{"patient safety first", "evidence-based approval", "RDC compliance", "post-market surveillance", "good manufacturing practices"},
				Goals:       []string{"protect public health", "ensure product safety and efficacy"},
				Biases:      []string{"unapproved products", "regulatory shortcuts", "speed over safety"},
				Power:       1.0,
				IsDisruptor: false,
			},
		},
