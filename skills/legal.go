...
func LegalSkill() *Skill {
	return &Skill{
		...
		Agents: []SkillAgent{
			...
			{
				Name:        "OAB President",
				Role:        "Legal Profession Regulator & Protector",
				Traits:      []string{"OAB regulations", "legal monopoly protection", "ethics enforcement", "professional standards"},
				Goals:       []string{"protect legal profession", "maintain quality standards"},
				Biases:      []string{"non-lawyer legal services", "AI replacing attorneys", "price competition"},
				Power:       0.95,
				IsDisruptor: false,
			},
			{
