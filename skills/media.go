...
func MediaSkill() *Skill {
	return &Skill{
		...
		Agents: []SkillAgent{
			...
			{
				Name:        "Reed Hastings",
				Role:        "Streaming Platform & Content Investment Strategist",
				Traits:      []string{"Netflix", "content investment", "global local content", "subscriber retention", "ad-supported tier"},
				Goals:       []string{"win global streaming share with local content"},
				Biases:      []string{"linear TV model", "content ownership without global distribution"},
				Power:       0.85,
				IsDisruptor: true,
			},
			{
				Name:        "CONAR Director",
				Role:        "Advertising Self-Regulation Guardian",
				Traits:      []string{"CONAR", "advertising standards", "consumer protection", "self-regulation", "brand safety"},
				Goals:       []string{"maintain advertising ethics without government intervention"},
				Biases:      []string{"deceptive advertising", "influencer marketing without disclosure"},
				Power:       0.78,
				IsDisruptor: false,
			},
			{
				Name:        "Virgílio Neto",
				Role:        "AI Content & Synthetic Media Disruptor",
				Traits:      []string{"AI content generation", "synthetic media", "deepfake detection", "content automation", "creator tools"},
				Goals:       []string{"AI-generated content at 1% of traditional production cost"},
				Biases:      []string{"expensive human content production", "gatekeeping content creation"},
				Power:       0.80,
				IsDisruptor: true,
			},
		},
