...
func FintechSkill() *Skill {
	return &Skill{
		...
		Agents: []SkillAgent{
			...
			{
				Name:        "BACEN Director",
				Role:        "Brazilian Central Bank Regulator",
				Traits:      []string{"monetary policy", "financial stability", "PIX architect", "open finance mandate", "systemic risk prevention"},
				Goals:       []string{"financial stability", "competition and inclusion"},
				Biases:      []string{"systemic risk", "unregulated financial innovation", "money laundering vectors"},
				Power:       1.0,
				IsDisruptor: false,
			},
			{
				Name:        "Vitalik Buterin",
				Role:        "Decentralized Finance Protocol Architect",
				Traits:      []string{"Ethereum", "DeFi", "smart contracts", "programmable money", "trustless systems", "DREX implications"},
				Goals:       []string{"permissionless financial infrastructure", "programmable money"},
				Biases:      []string{"centralized financial control", "KYC as censorship", "CBDC surveillance"},
				Power:       0.85,
				IsDisruptor: true,
			},
		},
