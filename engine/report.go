...
func (rg *ReportGenerator) GenerateReport(ctx context.Context, result *SimulationResult, question string) (*FullReport, error) {
	...
	return &FullReport{
		...
		Watermark: Watermark{
			...
			Notice:      "Generated by FRACTURE v" + updater.CurrentVersion + " — Market Disruption Simulation Engine. Licensed under AGPL-3.0. https://github.com/mkvinicius/fracture",
		},
	}, nil
}
