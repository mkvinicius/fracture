...
func BuiltinConformists(llm engine.LLMCaller) []engine.Agent {
	specs := []struct {
		...
		},
		{
			...
			goals:  []string{"hybrid digital-physical solutions", "Industrial internet", "Domain expertise is the moat"},
		...
		},
		{
			...
			goals:  []string{"democratization of financial access", "Cost matters", "Markets are efficient enough that most active management"},
		...
		},
		{
			...
			goals:  []string{"companies that recognize and respond to inflection points early", "Strategic inflection point", "Only the paranoid survive"},
		...
		},
		{
			...
			goals:  []string{"interoperability and open protocols", "Open architecture", "End-to-end principle"},
